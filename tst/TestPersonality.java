...
public class TestPersonality {
    ...
    public static final String ACTUAL_OUTPUT_BATCH_FILE_NAME = "actual_batch_output.txt";
    ...
    public static final String ACTUAL_OUTPUT_SINGLE_FILE_NAME = "actual_given_output.txt";
    ...
    private void testAreFilesIdentical(String expectedFilePath, String actualFilePath) throws IOException {
        ...
        Scanner actualFileScanner = new Scanner(actualFile);
        while (expectedFile.hasNextLine()) {
            String expectedLine = expectedFile.nextLine();
            Assertions.assertTrue(actualFileScanner.hasNextLine(), "Actual File should not have less content than expected");
            String actualLine = actualFileScanner.nextLine();
        ...
        Assertions.assertFalse(actualFileScanner.hasNextLine(), "Actual File should not have more content than Expected File");

        // close files so that they can be deleted after all tests are complete
        expectedFile.close();
